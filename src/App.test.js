...
export default function CustomPaginationActionsTable() {
 ...
 if (fetchData.loading){
   return (<div>Loader chal ra hai</div>)
 } else {
  return (
    <TableContainer component={Paper}>
      <Table className={classes.table} aria-label="custom pagination table" size="small">
        <TableHead>
          <TableRow>
          <TableCell style={{ minWidth: 270 }}>UserID</TableCell>
                  <TableCell style={{ minWidth: 160 }}>ID</TableCell>
                  <TableCell style={{ minWidth: 140 }}>Title</TableCell>
                  <TableCell style={{ minWidth: 270 }}>Body</TableCell>
          </TableRow>
        </TableHead>
        <TableBody>
          {(rowsPerPage > 0
